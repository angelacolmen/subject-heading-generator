...
Returns heading type for each result (main heading, subdivision, genre form, etc.)
Copy individual headings or all at once
...
Click the 🔑 API key section and paste your Anthropic API key
Paste a book title, description, or summary into the text box
...
Claude (claude-sonnet-4) via the Anthropic API
